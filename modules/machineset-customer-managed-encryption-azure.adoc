...
[role="_abstract"]
To enhance data security, enable customer-managed encryption on {azure-full} by adding the disk encryption set ID to your `MachineSet`.
...
* https://docs.microsoft.com/en-us/azure/virtual-machines/disk-encryption#customer-managed-keys[{azure-short} documentation about customer-managed keys]