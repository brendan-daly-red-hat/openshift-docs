...
`spec.template.spec.providerSpec.value.placementGroupPartition`:: Optional: Specifies the partition number of the existing {aws-short} placement group to deploy machines in.
--
.Verification
