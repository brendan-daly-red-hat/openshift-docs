...
[NOTE]
=====
If you use the bring your own (BYO) `iamRole`, the following IAM permissions are not required: `iam:CreateRole`,`iam:DeleteRole`, `iam:DeleteRolePolicy`, and `iam:PutRolePolicy`.
=====
