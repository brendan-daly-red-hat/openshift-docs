...
[role="_abstract"]
You can enable Accelerated Networking on {azure-full} by adding `acceleratedNetworking` to your machine set YAML file. This uses SR-IOV to help improve network performance for new nodes.
...
`providerSpec.value.vmSize`:: Specifies a {azure-short} VM size that includes at least four vCPUs. For information about VM sizes, see link:https://docs.microsoft.com/en-us/azure/virtual-machines/sizes[{azure-full} documentation].
--
