...
[id="ocp-4-21-installation-and-update-custom-aws-dns_{context}"]
=== Installing a cluster on {aws-first} with a user-provisioned DNS
...
For more information, see... [Enabling user-managed DNS] and [Optional AWS configuration parameters]
