...
`spec.template.spec.metadata.labels.cluster-api/accelerator`:: Specifies a label of your choice that consists of alphanumeric characters, `-`, `_`, or `.` and starts and ends with an alphanumeric character.
