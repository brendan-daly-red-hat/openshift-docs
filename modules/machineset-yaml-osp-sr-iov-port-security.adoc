...
--
`allowedAddressPairs`:: Specifies the allowed address pairs for the API and ingress ports.
`<machines_subnet_UUID>`:: Specifies the machines network and subnet.
`<machines_network_UUID>`:: Specifies the machines network and subnet.
