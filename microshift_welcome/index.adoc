...
* xref:../microshift_install_rpm/microshift-install-rpm.adoc#microshift-install-rpm[Installing with an RPM package]
...
* link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/9/html/composing_installing_and_managing_rhel_for_edge_images/index[RHEL for Edge documentation]
* link:https://docs.openshift.com/container-platform/{ocp-version}/welcome/index.html[OpenShift Container Platform documentation]
