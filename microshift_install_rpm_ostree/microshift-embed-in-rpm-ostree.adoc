...
* xref:../microshift_install_get_ready/microshift-install-get-ready.adoc#microshift-install-system-requirements_microshift-install-get-ready[System requirements for installing MicroShift]
