...
include::modules/microshift-rhde-compatibility-table.adoc[leveloffset=+3]

[id="microshift-about-updates-rpm-updates_{context}"]
=== Manual RPM updates
You can use the manual RPM update path to replace your existing version of {microshift-short}. The versions of {op-system-base} and {microshift-short} must be compatible. Ensuring system health and completing additional system backups are manual processes.
